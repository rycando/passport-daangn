...
function Strategy(options, verify) {
  ...
  if (!options.app_id || !options.app_secret) { throw new TypeError('app info is essential'); }
  ...
  this._scope = options.scope || 'account/profile';
  this._header = 'Basic ' + Buffer.from(options.app_id + ':' + options.app_secret).toString('base64');
